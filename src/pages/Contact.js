    ...
    <div>
      ...
      <div>
        <form onSubmit={handleSubmit(sendValue)}>
          <input className='name brd' type='text' placeholder='First Name*' {...register('name', {required: 'Please enter your Name', maxLength: {value: 12, message: 'Max length is 12 symbols'}
          })} />
          {errors.name && <p className='contact__err-msg'>{errors.name.message}</p>}
          <input className='lastname brd' type='text' placeholder='Last Name*' {...register('lastname', {required: 'Plase enter your Last name',
